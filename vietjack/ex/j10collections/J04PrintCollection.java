...
//Ví dụ sau minh họa cách in một Collection 
//bởi sử dụng phương thức tMap.keySet(), tMap.values() và tMap.firstKey() của lớp Java Util trong Java.

import java.util.TreeMap;

public class J04PrintCollection {
